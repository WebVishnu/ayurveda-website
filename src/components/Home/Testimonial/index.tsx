    ...
    return (
        <section className="lg:py-28 py-16 bg-grey dark:bg-darkmode">
            <div className="container mx-auto lg:max-w-(--breakpoint-xl) px-4">
                ...
                Discover what our customers are saying about Arogya Jeevan Ayurveda products. Real experiences from real people who have transformed their health naturally.
                </p>
                <div className="mt-20">
                    <Slider {...settings}>
