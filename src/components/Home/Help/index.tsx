            ...
            <div className="container mx-auto lg:max-w-(--breakpoint-xl) px-4">
                <div className="text-center">
                    <h2 className="text-3xl mb-3 font-medium" data-aos-delay={'100'} data-aos="fade-right">
                        WHY AROGYA JEEVAN AYURVEDA
                    </h2>
                    <p className="text-muted dark:text-white/60 text-base">
                    Everyone wants to live healthily and Ayurveda is the only ancient medical<br className="lg:block hidden" /> system that helps people live disease-free and healthy.
                    </p>
