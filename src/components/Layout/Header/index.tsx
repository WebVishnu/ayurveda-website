 ...
 const info = useContext(DonationFormContext);
  ...
  return (
    ...
    >
      <div className="sm:bg-linear-to-r bg-linear-to-l md:from-primary md:to-secondary lg:py-0 py-2 bg-white dark:bg-dark">
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) flex items-center justify-between px-4">
          ...
          <div className="flex items-center space-x-4 relative top-[1px]">
            ...
            <Link
              href="/wishlist"
              className="relative flex h-8 w-8 items-center justify-center text-body-color duration-300 dark:text-white"
            >
              <Icon icon="mdi:heart-outline" className="text-xl" />
              <span className="absolute -top-1 -right-1 bg-error text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">0</span>
            </Link>
            {/* Shopping Cart Icon */}
            <Link
              href="/cart"
      ...
      <div className="px-4 container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) sm:flex lg:justify-between justify-center py-5 hidden lg:flex">
        ...
        <div className="flex items-center gap-6">
          <div className="flex gap-3 py-2 pr-6 border-r dark:border-dark_border">
            ...
            <div className="">
              ...
              <Link href="mailto:arogyajeevancc@gmail.com" className="text-base font-semibold mb-0 hover:text-primary">
                arogyajeevancc@gmail.com
              </Link>
            </div>
          </div>
          <div className="flex gap-3 py-2 pl-6 pr-6 border-r dark:border-dark_border">
            <Image
            ...
            <div className="">
              ...
              <Link href="tel:+919667794027" className="text-base font-semibold mb-0 hover:text-primary">
                +91-9667794027
              </Link>
            </div>
          </div>
          <div className="flex items-center gap-2 pl-6">
            <span className="text-sm text-muted dark:text-white/60">Language</span>
            <select className="bg-transparent border-none text-base font-semibold text-midnight_text dark:text-white focus:outline-none cursor-pointer">
              <option value="en" className="text-gray-800">English</option>
              <option value="de" className="text-gray-800">Deutsch</option>
              <option value="it" className="text-gray-800">Italia</option>
            </select>
          </div>
        </div>
      </div>
